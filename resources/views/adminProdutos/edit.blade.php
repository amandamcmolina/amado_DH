...
<body class="col-10 offset-1 py-5">
  ...
  {{-- Estamos usando o PUT mas os navegadores ainda não entendem o método PUT, então, o laravel vai alterar --}}
        @method('put')
        @csrf
        {{-- NOME --}}
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="marca" id="marca" placeholder="Marca" value="{{ $produto->marca }}">
          </div>
        </div>
        {{-- QUANTIDADE --}}
        <div class="form-group row">
